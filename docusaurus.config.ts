...
const config: Config = {
  title: 'Insightech Flutter SDK',
  tagline: 'Session replay, heatmaps, and analytics for Flutter apps',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://insightechprojects.github.io/react-native-sdk-docs/',
